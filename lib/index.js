...
module.exports = function loader(content) {
  ...
  return img.metadata().then(function (metadata) {
    ...
    loaderCallback(null, 'module.exports = {' + 'srcSets:' + JSON.stringify(srcSets) + ',' + 'images:[' + images + '],' + 'src:' + firstImage.path + ',' + 'toString:function(){return ' + firstImage.path + '},' + 'placeholder: ' + placeholder + ',' + 'width:' + firstImage.width + ',' + 'height:' + firstImage.height + '};');
  }).catch(function (err) {
