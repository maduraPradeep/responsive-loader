...
module.exports = function loader(content) {
  ...
  var createFile = function createFile(_ref2) {
    ...
    var src = publicPath + `+${JSON.stringify(` ${width}w`)}`;
  ...
  return img.metadata().then(function (metadata) {
    ...
    var srcSets = [];
    var images = '';
    for (var _ref5 in Object.entries(srcSetGroups)) {
    ...
    loaderCallback(null, 'module.exports = {' + 'srcSets:' + srcSets + ',' + 'images:[' + images + '],' + 'src:' + firstImage.path + ',' + 'toString:function(){return ' + firstImage.path + '},' + 'placeholder: ' + placeholder + ',' + 'width:' + firstImage.width + ',' + 'height:' + firstImage.height + '};');
  }).catch(function (err) {
